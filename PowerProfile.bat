...
if /i "%~1"=="-toggle" (
    powershell.exe -Command "Start-Process powershell.exe -ArgumentList '-ExecutionPolicy Bypass -NoProfile -File \"%~dp0PowerProfile.ps1\" -Toggle' -Verb RunAs -WindowStyle Hidden"
) else (
